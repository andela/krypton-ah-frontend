...
const getUserArticleRating = ratingdetails => async (dispatch) => {
  try {
    dispatch(triggerLoading(GET_USER_RATING_LOADING));
    const response = await getUserRating(ratingdetails.articleId, ratingdetails.userId);

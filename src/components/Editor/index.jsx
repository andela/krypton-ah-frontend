  ...
  renderTitle(article) {
    return (
      <Form.Field required>
        ...
        <Input className="titleInput" id="title" name="title" value={article.title} onChange={this.handleChange} />
      </Form.Field>
    );
  }
  ...
  renderDescription(article) {
    return (
      <Form.Field required>
        ...
        <TextArea id="description" name="description" maxLength="255" value={article.description} onChange={this.handleChange} />
      </Form.Field>
    );
  }
  ...
  renderCategory(article) {
    return (
      <Form.Field className="categoryForm" required>
        ...
        <select id="category" name="category" value={article.category} onChange={this.handleSelection} placeholder="Select article category">
  ...
  renderContent(article) {
    return (
      <Form.Field required>
        ...
        <MediumEditor id="content" options={mediumEditorOptions} text={article.content} onChange={this.handleEditorChange} />
      </Form.Field>
    );
  }
    ...
    return (
      <Form.Field>
        ...
        <div className="previewImage">
          ...
          <Input id="fileUpload" type="file" content="Browse" name="featuredImage" onChange={this.handleImageUpload} />
        </div>
      </Form.Field>
    );
  }
